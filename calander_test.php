...
$event_display="<P><a href='###LINK###'><B>###TITLE###</b> - ###FROM### ###DATESTART###</a><br>###DESCRIPTION###</p>";
...
$calendar_xml_address = str_replace("/basic","/full?singleevents=true&futureevents=true&max-results".$items_to_show."orderby=lastmodified&sortorder=a",$calendarfeed); //This goes and gets future events in your feed.

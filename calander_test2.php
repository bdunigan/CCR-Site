...
if (!isset($calendarfeed)) {$calendarfeed = "https://www.google.com/calendar/feeds/p92fl4qha7k1ucuarisucqbeto%40group.calendar.google.com/private-0c1926c9cec90409056d9346fa914daf/basic"; }
...
$event_display="<P><B>###TITLE###</b> - from ###FROM### ###DATESTART### until ###UNTIL### ###DATEEND### (<a href='###LINK###'>add this</a>)<BR>###WHERE### (<a href='###MAPLINK###'>map</a>)<br></p>";
...
$calendar_xml_address = str_replace("/basic","/basic?singleevents=false&max-results=35&sortorder=ascending&start-min=2012-01-30T23:59:59&futureevents=true",$calendarfeed); //This goes and gets future events in your feed.
